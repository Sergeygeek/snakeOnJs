...
/**
 * Объект счетчика очков игрока
 * @property {int} count Очки игрока
 * @property {HTMLElement} countEl DOM-элемент для вставки количества набранных очков
 */
const score = {
  count: null,
  countEl: null,
   ...
   */
  init() {
    // Найдем объект для отображения очков
  ...
  /**
   * Ставит счет в ноль и отрисовывает
   */
  drop() {
    // Ставим счет в ноль
    this.count = 0;
  ...
  /**
   * Отрисовывает счет пользователя
   */
  render() {
